        ...
        <footer className="footer">
          <div className="container">
            <div className="content has-text-center">
              <div className="site">
                <a href="https://www.facebook.com/adam.barta.338/">
                  <img src={img1} width="20px" alt='' />
                </a>
                <a href="https://www.instagram.com/barta_adam_/">
                  <img src={img2} width="20px" alt='' />
                </a>
                <a href="https://steamcommunity.com/profiles/76561198377122431/">
                  <img src={img3} width="20px" alt='' />
                </a>
                <a href="https://www.twitch.tv/b4rt1k1">
